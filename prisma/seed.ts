...
async function main() {
  ...
  const FR: OfferInput[] = [
    {
      ...
      salaryMin: 50000, salaryMax: 60000, salaryPeriod: "mois", salaryRaw: "50 000 - 60 000 FCFA/mois",
    ...
    },
    {
      ...
      salaryMin: 25000, salaryMax: 30000, salaryPeriod: "mois", salaryRaw: "25 000 - 30 000 FCFA/mois",
      workArrangement: "NAVETTE", contractDuration: "PERMANENT",
    ...
    },
    {
      ...
      salaryMin: 70000, salaryMax: 85000, salaryPeriod: "mois", salaryRaw: "70 000 - 85 000 FCFA/mois",
    ...
    },
    {
      ...
      salaryMin: 80000, salaryMax: 90000, salaryPeriod: "mois", salaryRaw: "80 000 - 90 000 FCFA/mois",
    ...
    },
    {
      ...
      salaryMin: 45000, salaryMax: 50000, salaryPeriod: "mois", salaryRaw: "45 000 - 50 000 FCFA/mois",
    ...
    },
    {
      ...
      salaryMin: 15000, salaryMax: 20000, salaryPeriod: "jour", salaryRaw: "15 000 - 20 000 FCFA/jour",
    ...
    },
    {
      ...
      salaryMin: 55000, salaryMax: 65000, salaryPeriod: "mois", salaryRaw: "55 000 - 65 000 FCFA/mois",
    ...
    },
    {
      ...
      salaryMin: 35000, salaryMax: 40000, salaryPeriod: "mois", salaryRaw: "35 000 - 40 000 FCFA/mois",
    ...
    },
    {
      ...
      salaryMin: 20000, salaryMax: 25000, salaryPeriod: "jour", salaryRaw: "20 000 - 25 000 FCFA/jour",
    ...
    },
    {
      ...
      salaryMin: 60000, salaryMax: 60000, salaryPeriod: "mois", salaryRaw: "60 000 FCFA",
    ...
    },
    {
      ...
      salaryMin: 40000, salaryMax: 45000, salaryPeriod: "mois", salaryRaw: "40 000 - 45 000 FCFA/mois",
    ...
    },
    {
      ...
      salaryMin: 65000, salaryMax: 75000, salaryPeriod: "mois", salaryRaw: "65 000 - 75 000 FCFA/mois",
    ...
    },
    {
      ...
      salaryMin: 15000, salaryMax: 15000, salaryPeriod: "jour", salaryRaw: "15 000 FCFA/jour",
  ...
  const EN: OfferInput[] = [
    {
      ...
      salaryMin: 90000, salaryMax: 110000, salaryPeriod: "mois", salaryRaw: "90,000 - 110,000 FCFA/month",
    ...
    },
    {
      ...
      salaryMin: 60000, salaryMax: 70000, salaryPeriod: "mois", salaryRaw: "60,000 - 70,000 FCFA/month",
    ...
    },
    {
      ...
      salaryMin: 100000, salaryMax: 120000, salaryPeriod: "mois", salaryRaw: "100,000 - 120,000 FCFA/month",
    ...
    },
    {
      ...
      salaryMin: 30000, salaryMax: 35000, salaryPeriod: "mois", salaryRaw: "30,000 - 35,000 FCFA/month",
  ...
  const AR: OfferInput[] = [
    {
      ...
      salaryMin: 55000, salaryMax: 65000, salaryPeriod: "mois", salaryRaw: "55,000 - 65,000 فرنك أفريقي شهرياً",
    ...
    },
    {
      ...
      salaryMin: 85000, salaryMax: 95000, salaryPeriod: "mois", salaryRaw: "85,000 - 95,000 فرنك أفريقي شهرياً",
    ...
    },
    {
      ...
      salaryMin: 60000, salaryMax: 70000, salaryPeriod: "mois", salaryRaw: "60,000 - 70,000 فرنك أفريقي شهرياً",
    ...
    },
    {
      ...
      salaryMin: 75000, salaryMax: 90000, salaryPeriod: "mois", salaryRaw: "75,000 - 90,000 فرنك أفريقي شهرياً",
  ...
  const ZH: OfferInput[] = [
    {
      ...
      salaryMin: 55000, salaryMax: 65000, salaryPeriod: "mois", salaryRaw: "55,000 - 65,000 西非法郎/月",
    ...
    },
    {
      ...
      salaryMin: 90000, salaryMax: 100000, salaryPeriod: "mois", salaryRaw: "90,000 - 100,000 西非法郎/月",
    ...
    },
    {
      ...
      salaryMin: 40000, salaryMax: 45000, salaryPeriod: "mois", salaryRaw: "40,000 - 45,000 西非法郎/月",
    ...
    },
    {
      ...
      salaryMin: 80000, salaryMax: 95000, salaryPeriod: "mois", salaryRaw: "80,000 - 95,000 西非法郎/月",
  ...
  for (const [i, offer] of allOffers.entries()) {
    await prisma.announcement.upsert({
      where: { sourceId_externalId: { sourceId: source.id, externalId: `ml-${i}` } },
      create: {
        sourceId: source.id,
        externalId: `ml-${i}`,
        type: "OFFER",
        ...
        contact: "0700000000 (donnée de test)",
  ...
  console.log(`${allOffers.length} offres créées : FR=${FR.length}, EN=${EN.length}, AR=${AR.length}, ZH=${ZH.length}`);
}
