  ...
  return (
    <div className="h-full w-full overflow-x-hidden bg-white dark:bg-zinc-900 px-4 sm:px-5" dir={isRtl ? 'rtl' : 'ltr'} >
      ...
      <main className="relative flex w-full flex-col pt-5 xl:pt-0 sm:pt-16 lg:pt-19">
        ...
        <div className="flex flex-col xl:flex-row items-center lg:items-start justify-between gap-6 lg:gap-0 mt-8 lg:mt-0">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between mt-8 lg:mt-15 gap-6 lg:gap-0">
