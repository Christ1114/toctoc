...
const TermsOfUseComponent = () => {
  ...
  const content = {
    ...
    point5Label: t("content.point5Label"),
    point5Item1: t("content.point5Item1"),
    point5Item2: t("content.point5Item2"),
    point6: t("content.point6"),
    point7Label: t("content.point7Label"),
    point7Item1: t("content.point7Item1"),
    point7Item2: t("content.point7Item2"),
    point8: t("content.point8"),
        ...
        >
          <thead>
            <tr className="bg-zinc-100 dark:bg-zinc-800">
              <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-bold">
          ...
          <tbody>
            <tr className="border-t border-zinc-300 dark:border-zinc-700">
              <td className="px-2 sm:px-4 py-2 sm:py-3 font-semibold">{table.title}</td>
              <td className="px-2 sm:px-4 py-2 sm:py-3">{table.date}</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="mt-4 sm:mt-6 lg:mt-8 leading-relaxed w-full text-xs sm:text-sm md:text-base lg:text-lg">
        <div className="space-y-3 sm:space-y-4 lg:space-y-5">
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc pl-4 sm:pl-6 space-y-1.5 sm:space-y-2">
              <li className="wrap-break-words text-zinc-700 dark:text-zinc-300">{content.point5Item1}</li>
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc pl-4 sm:pl-6 space-y-1.5 sm:space-y-2">
              <li className="wrap-break-words text-zinc-700 dark:text-zinc-300">{content.point7Item1}</li>
